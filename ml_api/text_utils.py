...
def ml_features(text: str) -> str:
    """Normalized feature string for TF-IDF (train + inference)."""
...
def hate_token_negated(text: str) -> bool:
    return _hate_token_negated(text)


def has_safe_hate_context(text: str) -> bool:
    return _has_safe_hate_context(text)
